...
//SoftwareSerial Serial_DHT(D3, DHT22);
//DHT dht(Serial_DHT);
//DHT::DATA data;
DHT dht(D3, DHT22);
const char* ssid = "bae"; //사용하는 Wifi 이름
const char* password = "29344399"; // 비밀번호
const char* mqtt_server = "192.168.46.88"; //mqtt 서버 주소(라즈베리파이에서 ifconfig로 inet 주소 확인)
const char* clientName = "020731Client"; // client 이름(생일 추천드려요~)
...
//  if(dht.read(data)) // 만약 PMS센서에서 받은 값이 존재한다면
//  {
