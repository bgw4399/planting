...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setPixmap(QtGui.QPixmap("./flower-pot.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "스마트 식물 팜"))
        ...
        self.label_5.setText(_translate("MainWindow", f'이름:\n\n'
        f'적정 습도: \n\n'
        f'적정 온도: \n\n'
        f'적정 토양 습도: '))
    ...
    def button_tmp_minus(self):
      if self.isAuto:
        ...
        self.now_tmp -= 1
        self.tmp.setText(str(self.now_tmp))
        # client.publish('common', json.dumps({"success": "ok"}), 2)
    ...
    def button_solidHum_plus(self):
      if self.isAuto:
        ...
        self.now_soilhum += 1
        self.soilhum.setText(str(self.now_soilhum))
        # client.publish('common', json.dumps({"success": "ok"}), 3)
    ...
    def button_solidHum_minus(self):
      if self.isAuto:
        ...
        self.now_soilhum -= 1
        self.soilhum.setText(str(self.now_soilhum))
        # client.publish('common', json.dumps({"success": "ok"}), 4)
    ...
    def button_hum_plus(self):
      if self.isAuto:
        ...
        self.now_hum += 1
        self.hum.setText(str(self.now_hum))
        # client.publish('common', json.dumps({"success": "ok"}), 5)
    ...
    def button_hum_minus(self):
      if self.isAuto:
        ...
        self.now_hum -= 1
        self.hum.setText(str(self.now_hum))
        # client.publish('common', json.dumps({"success": "ok"}), 6)
